...
(function () {
  ...
  a.operation = b(function (h, n, g, m, l) {
    ...
    d = g["if"].call(n, n.notes, {hash: {}, inverse: r.noop, fn: r.program(1, f, l), data: l});
    if (d || d === 0) {
      j += d
    }
    j += "\n        ";
    d = g["if"].call(n, n.type, {hash: {}, inverse: r.noop, fn: r.program(3, c, l), data: l});
    if (d || d === 0) {
      j += d
    }
    j += "\n        <form accept-charset='UTF-8' class='sandbox'>\n          <div style='margin:0;padding:0;display:inline'></div>\n          ";
    d = g["if"].call(n, n.parameters, {hash: {}, inverse: r.noop, fn: r.program(5, q, l), data: l});
    if (d || d === 0) {
      j += d
    }
    j += "\n          ";
    d = g["if"].call(n, n.responseMessages, {hash: {}, inverse: r.noop, fn: r.program(7, p, l), data: l});
    if (d || d === 0) {
      j += d
    }
    j += "\n          ";
    d = g["if"].call(n, n.isReadOnly, {hash: {}, inverse: r.program(11, e, l), fn: r.program(9, o, l), data: l});
    if (d || d === 0) {
      j += d
    }
...
(function () {
  ...
  a.param = b(function (f, q, o, j, s) {
    ...
    function k(x, w) {
      var u = "", v;
      u += "\n			";
      v = o["if"].call(x, x.defaultValue, {hash: {}, inverse: n.program(7, h, w), fn: n.program(5, i, w), data: w});
      if (v || v === 0) {
        u += v
      }
      u += "\n		";
    ...
    function e(x, w) {
      var u = "", v;
      u += "\n		";
      v = o["if"].call(x, x.defaultValue, {hash: {}, inverse: n.program(12, r, w), fn: n.program(10, t, w), data: w});
      if (v || v === 0) {
        u += v
      }
      u += "\n	";
...
(function () {
  ...
  a.param_list = b(function (g, r, p, l, w) {
    ...
    function k(A, z) {
      var x = "", y;
      x += "\n      ";
      y = p["if"].call(A, A.defaultValue, {hash: {}, inverse: o.program(8, h, z), fn: o.program(6, j, z), data: z});
      if (y || y === 0) {
        x += y
      }
      x += "\n    ";
    ...
    function h(A, z) {
      var x = "", y;
      x += "\n        ";
      y = p["if"].call(A, A.allowMultiple, {hash: {}, inverse: o.program(11, v, z), fn: o.program(9, f, z), data: z});
      if (y || y === 0) {
        x += y
      }
      x += "\n      ";
    ...
    function u(A, z) {
      var x = "", y;
      x += "\n      ";
      y = p["if"].call(A, A.isDefault, {hash: {}, inverse: o.program(16, s, z), fn: o.program(14, t, z), data: z});
      if (y || y === 0) {
        x += y
      }
      x += "\n    ";
    ...
    if (i = p.name) {
      ...
      i = r.name;
      i = typeof i === d ? i.apply(r) : i
    }
    q += c(i) + "</td>\n<td>\n  <select ";
    i = p["if"].call(r, r.allowMultiple, {hash: {}, inverse: o.noop, fn: o.program(1, n, w), data: w});
    if (i || i === 0) {
      q += i
    }
    ...
    q += c(i) + "'>\n    ";
    i = p["if"].call(r, r.required, {hash: {}, inverse: o.program(5, k, w), fn: o.program(3, m, w), data: w});
    if (i || i === 0) {
      q += i
    }
    q += "\n    ";
    e = p.each.call(r, ((i = r.allowableValues), i == null || i === false ? i : i.descriptiveValues), {
      hash: {},
      inverse: o.noop,
      fn: o.program(13, u, w),
      data: w
...
(function () {
  ...
  a.param_readonly = b(function (g, m, f, l, k) {
    ...
    function c(t, s) {
      var q = "", r;
      q += "\n        ";
      r = f["if"].call(t, t.defaultValue, {hash: {}, inverse: o.program(6, n, s), fn: o.program(4, p, s), data: s});
      if (r || r === 0) {
        q += r
      }
      q += "\n    ";
...
(function () {
  ...
  a.param_required = b(function (f, q, o, j, u) {
    ...
    function k(z, y) {
      var w = "", x;
      w += "\n			";
      x = o["if"].call(z, z.defaultValue, {hash: {}, inverse: n.program(7, h, y), fn: n.program(5, i, y), data: y});
      if (x || x === 0) {
        w += x
      }
      w += "\n		";
    ...
    function t(z, y) {
      var w = "", x;
      w += "\n			";
      x = o["if"].call(z, z.defaultValue, {hash: {}, inverse: n.program(15, r, y), fn: n.program(13, s, y), data: y});
      if (x || x === 0) {
        w += x
      }
      w += "\n		";
  ...
  o = (function (z) {
    ...
    y.prototype.render = function () {
      ...
      if (this.model.responseClassSignature && this.model.responseClassSignature !== "string") {
        Q = {sampleJSON: this.model.responseSampleJSON, isParam: false, signature: this.model.responseClassSignature};
    ...
    y.prototype.handleFileUpload = function (Q, I) {
      var M, H, C, N, L, K, J, G, E, D, P, T, S, R, F, B, A, U, O = this;
      ...
      log(C);
      U = I.find('input[type~="file"]');
      for (D = 0, R = U.length; D < R; D++) {
        H = U[D];
        M.append($(H).attr("name"), H.files[0])
      }
      log(M);
      this.invocationUrl = this.model.supportHeaderParams() ? (C = this.model.getHeaderParams(Q), this.model.urlify(Q, false)) : this.model.urlify(Q, true);
      ...
      L = {
        ...
        error: function (W, X, V) {
          return O.showErrorStatus(O.wrap(W), O)
        },
        success: function (V) {
          return O.showResponse(V, O)
        },
        complete: function (V) {
          return O.showCompleteStatus(O.wrap(V), O)
        }
      };
    ...
    y.prototype.wrap = function (E) {
      var F, H, A, G, D, C, B;
      H = {};
      F = E.getAllResponseHeaders().split(":");
      for (A = D = 0, C = F.length / 2, B = 2; B > 0 ? D <= C : D >= C; A = D += B) {
        H[F[A]] = F[A + 1]
      }
      G = {};
      G.content = {};
    ...
    y.prototype.showStatus = function (A) {
      ...
      C = A.data;
      F = A.headers;
      G = F && F["Content-Type"] ? F["Content-Type"].split(";")[0].trim() : null;
      if (!C) {
        D = $("<code />").text("no content");
        E = $('<pre class="json" />').append(D)
      } else {
        if (G === "application/json" || /\+json$/.test(G)) {
          D = $("<code />").text(JSON.stringify(JSON.parse(C), null, "  "));
          E = $('<pre class="json" />').append(D)
        } else {
          if (G === "application/xml" || /\+xml$/.test(G)) {
            D = $("<code />").text(this.formatXml(C));
            E = $('<pre class="xml" />').append(D)
          } else {
            if (G === "text/html") {
              D = $("<code />").html(C);
              E = $('<pre class="xml" />').append(D)
      ...
      B = E;
      $(".request_url", $(this.el)).html("<pre>" + A.url + "</pre>");
      $(".response_code", $(this.el)).html("<pre>" + A.status + "</pre>");
      $(".response_body", $(this.el)).html(B);
