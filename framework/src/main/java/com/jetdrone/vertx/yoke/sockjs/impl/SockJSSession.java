...
public class SockJSSession extends SockJSSocketBase implements Shareable {
  ...
  SockJSSession(Vertx vertx, LocalMap<String, SockJSSession> sessions, YokeRequest rc, long heartbeatInterval,
                Handler<SockJSSocket> sockHandler) {
    this(vertx, sessions, rc, null, -1, heartbeatInterval, sockHandler);
  }

  SockJSSession(Vertx vertx, LocalMap<String, SockJSSession> sessions, YokeRequest rc, String id, long timeout, long heartbeatInterval,
                Handler<SockJSSocket> sockHandler) {
    super(vertx);
